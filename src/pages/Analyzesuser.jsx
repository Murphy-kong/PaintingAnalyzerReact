...
import { defaultavatar, AllUserAvatarAPI, UserDeleteAPI, AllUserImagesAPI, OneUserImageDeleteAPI, AllAnaylzesAPI, SingleAnaylzesAPI  } from "../pages/APIcalls";
...
const Analyzesuser = (props ) => {
    ...
    async function GetAnalyzes() {
      console.log(props)
      var result = await SingleAnaylzesAPI()
